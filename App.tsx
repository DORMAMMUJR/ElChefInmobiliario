...
import { PROPIEDADES, TRANSLATIONS, FORMAT_PRICE, CONTACT_INFO, VENTAJAS, TESTIMONIOS } from './constants';
            ...
            {['home', 'catalog', 'sell', 'concierge', 'contact'].map(view => (
              <button 
                ...
                onClick={() => {
                    ...
                    if(view === 'concierge') setConciergeStep('intro');
                }}
                ...
                <div className="w-full lg:w-1/2 flex flex-col justify-center px-8 lg:px-24 py-20 lg:py-12 border-l border-white/5 bg-[#011c16] relative">
                   <div className="max-w-xl">
                      <div className="mb-12">
                        ...
                        <h2 className="text-6xl lg:text-9xl font-serif font-black mb-6 tracking-tighter uppercase leading-[0.8] text-white">
                          LA ALTA<br/><span className="text-[#D4AF37]">INMOBILIARIA</span>
                        </h2>
                      </div>
                      
                      <p className="text-white/40 text-sm md:text-lg leading-loose mb-16 italic border-l-2 border-[#D4AF37] pl-8 max-w-lg">
                        "Curaduría de activos de ultra-lujo y asesoría estratégica. Transformamos el mercado inmobiliario en una experiencia de deleite patrimonial."
                      </p>

                      <div className="flex flex-col md:flex-row gap-6">
                        <button onClick={() => setCurrentView('catalog')} className="btn-luxury-gold px-20 py-6 text-[11px] flex-grow md:flex-grow-0">
                          EXPLORAR PORTAFOLIO
                        </button>
                        <button onClick={() => setCurrentView('contact')} className="px-20 py-6 text-[11px] border border-white/10 hover:border-[#D4AF37] transition-all font-black uppercase tracking-[0.4em] flex-grow md:flex-grow-0">
                          CONSULTORÍA VIP
                        </button>
                      </div>
                   </div>
